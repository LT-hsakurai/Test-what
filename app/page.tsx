...
function RegisterScreen({ videoRef, regStep, progress, countdown, onStart, onFinish, onBack }: {
    ...
    <div className="space-y-4">
      ...
      {regStep === 'idle' && (
        <div className="space-y-3">
          <p className="text-slate-300 text-sm text-center">良品を画面中央に置いてください。ボタンを押すと3秒後に自動撮影が始まります。</p>
